  ...
  translation: {
    ...
    automations: {
      ...
      features: [
        ...
        "Seamless API integrations with major CRM and ERP systems",
      ...
      ui: {
        ...
        orderProcessed: "Order #8921 Processed",
        success: "Success",
        inventoryUpdated: "Inventory Updated",
        invoiceGenerated: "Invoice Generated",
        awaiting: "Awaiting next trigger...",
        pending: "Pending"
      }
    },
    roi: {
      title1: "Calculate ",
      titleHighlight: "real savings",
      title2: " with AI",
      subtitle: "Simulate the impact of automating administrative tasks with an AI Assistant",
      annualComparison: "ANNUAL COMPARISON",
      currentCost: "Current Cost",
      hybridCost: "Hybrid AI + Human",
      savings: "Savings",
      perYear: "/year",
      viewCalculator: "View Full Calculator",
      fields: {
        currentTeam: "Current Team",
        aiEmployees: "Employees with AI",
        monthlySalary: "Monthly Salary",
        annualPayments: "Annual Payments",
        socialSecurity: "Social Security",
        indirectCosts: "Indirect Costs",
        dailyTasks: "Admin Tasks per Day",
        people: "(people)",
        usd: "(USD)",
        percent: "(%)",
        tasks: "(tasks)"
    ...
    contact: {
      ...
      form: {
        ...
        company: "Company",
        phone: "Phone",
        phonePlaceholder: "Country code + number, e.g. +1 555 000 0000",
        phoneHelp: "Include the country code first, for example +1 555 000 0000",
        message: "Message",
      ...
      info: {
        ...
        office: "Office",
        officeText: "Come say hello at our headquarters.",
    ...
    thankYou: {
      ...
      subtitle: "We will get back to you soon to move your project forward.",
      returnButton: "Return to contact",
    ...
    serviceDetail: {
      ...
      ctaText: "Let's discuss how our {{service}} solutions can drive growth and efficiency for your organization.",
    ...
    privacy: {
      ...
      intro: "At Digital Constructions, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.",
      h1: "1. Information We Collect",
      p1: "We may collect personal information that you voluntarily provide to us when you express an interest in obtaining information about us or our products and services, when you participate in activities on the Website, or otherwise when you contact us.",
      h2: "2. How We Use Your Information",
      p2: "We use personal information collected via our Website for a variety of business purposes described below. We process your personal information for these purposes in reliance on our legitimate business interests, in order to enter into or perform a contract with you, with your consent, and/or for compliance with our legal obligations.",
      h3: "3. Information Sharing",
      p3: "We only share information with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfill business obligations."
    },
    terms: {
      title: "Terms of Service",
      lastUpdated: "Last updated: March 29, 2026",
      intro: "These Terms of Service constitute a legally binding agreement made between you, whether personally or on behalf of an entity (\"you\") and Digital Constructions (\"we,\" \"us\" or \"our\"), concerning your access to and use of our website and services.",
      h1: "1. Agreement to Terms",
      p1: "By accessing the website, you agree that you have read, understood, and agree to be bound by all of these Terms of Service. If you do not agree with all of these Terms of Service, then you are expressly prohibited from using the site and you must discontinue use immediately.",
      h2: "2. Intellectual Property Rights",
      p2: "Unless otherwise indicated, the website is our proprietary property and all source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics on the website (collectively, the \"Content\") and the trademarks, service marks, and logos contained therein (the \"Marks\") are owned or controlled by us or licensed to us.",
      h3: "3. User Representations",
      p3: "By using the website, you represent and warrant that: (1) all registration information you submit will be true, accurate, current, and complete; (2) you will maintain the accuracy of such information and promptly update such registration information as necessary."
    }
  }
};
